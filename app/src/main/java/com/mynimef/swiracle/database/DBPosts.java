...
public class DBPosts {
    ...
    private static final String COLUMN_TITLE = "TeamНоme";
    private static final String COLUMN_DESCRIPTION = "TeamGuest";
    ...
    public long insert(String teamhouse, String teamguest, int goalshouse, int goalsguest) {
        ...
        cv.put(COLUMN_TITLE, teamhouse);
        cv.put(COLUMN_DESCRIPTION, teamguest);
    ...
    public int update(Matches md) {
        ContentValues cv=new ContentValues();
        cv.put(COLUMN_TITLE, md.getTeamhouse());
        cv.put(COLUMN_DESCRIPTION, md.getTeamguest());
